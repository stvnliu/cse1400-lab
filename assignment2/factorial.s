...
.data
message:
	.asciz "Hi, We're Steven Liu (NetID: stevenliu) and Egor Yapparov (NetID: eyapparov). This is our submission for Assignment 2: Factorial\n"
question:
	.asciz "Factorial of: "
dbg_process:
...
factorial:
	...
	#RECURSION LOGIC!
	cmpq	$0, -8(%rbp)		# If current "factorial base number" is 0, we reach base condition
	jne	fact_recurse
fact_0:
	#!BASE CONDITION!
